...
## Data
- Pools agent-curated; `npm run words:check`. One lemma/card; exactly 3 sentences (legacy PT-BR may still have 2); content words only; regional flavour mandatory. No Tatoeba/scrape generators.
